...
public class ReaderBig(byte[] buffer) : IReader
{
    ...
    public Option<short> ReadInt16()
    {
        ...
        var data = BinaryPrimitives.ReadInt16BigEndian(GetSpan(ShortLen));
        Position += ShortLen;
        return data;
    }
    ...
    public Option<ushort> ReadUInt16()
    {
        ...
        var data = BinaryPrimitives.ReadUInt16BigEndian(GetSpan(ShortLen));
        Position += ShortLen;
        return data;
    }
    ...
    public Option<int> ReadInt32()
    {
        ...
        var data = BinaryPrimitives.ReadInt32BigEndian(GetSpan(IntLen));
        Position += IntLen;
        return data;
    }
    ...
    public Option<uint> ReadUInt32()
    {
        ...
        var data = BinaryPrimitives.ReadUInt32BigEndian(GetSpan(IntLen));
        Position += IntLen;
        return data;
    }
    ...
    public Option<long> ReadInt64()
    {
        ...
        var data = BinaryPrimitives.ReadInt64BigEndian(GetSpan(LongLen));
        Position += LongLen;
        return data;
    }
    ...
    public Option<ulong> ReadUInt64()
    {
        ...
        var data = BinaryPrimitives.ReadUInt64BigEndian(GetSpan(LongLen));
        Position += LongLen;
        return data;
    }
    ...
    public Option<string> ReadString() 
    {
        ...
        var length = BinaryPrimitives.ReadUInt16BigEndian(GetSpan(ShortLen));
        Position += ShortLen;
    ...
    public Option<string> ReadStringInt()
    {
        ...
        var length = BinaryPrimitives.ReadInt32BigEndian(GetSpan(IntLen));
        Position += IntLen;
